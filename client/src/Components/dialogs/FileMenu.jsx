        ...
        <MenuList>
          <MenuItem onClick={selectImage}>
            ...
            <input
              type="file"
              multiple
              accept="image/png,image/gpeg,image/gif"
              style={{ display: "none" }}
          ...
          <MenuItem>
            <Tooltip title="Audio" onClick={selectAudio}>
              <AudioFileIcon />
            </Tooltip>
          ...
          <MenuItem>
            <Tooltip title="Video" onClick={selectVideo}>
              <VideoFileIcon />
            </Tooltip>
          ...
          <MenuItem>
            <Tooltip title="File" onClick={selectFile}>
              <UploadFileIcon />
            </Tooltip>
